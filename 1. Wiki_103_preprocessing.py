...
def get_dataset_values_in_list():
    ...
    """
    data_test = pd.read_csv(os.path.join('..', '_utils', 'wikitext-103', 'test.csv'), header=None)[0].tolist()
    data_train = pd.read_csv(os.path.join('..', '_utils', 'wikitext-103', 'train.csv'), header=None)[0].tolist()
...
if __name__ == '__main__':
    ...
    # plot_most_common_without_stop_words(data)
    preprocess_text(data, os.path.join("data", "corpus_big.txt"))
