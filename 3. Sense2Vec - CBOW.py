...
if __name__ == '__main__':
    ...
    dataset_save_path = os.path.join(dataset_pickle_path,
                                       "ds_s{}_c{}.pth".format(str(seq_len), str(minimal_token_occurences)))
    ...
    if os.path.exists(token2idx_save_path) and os.path.exists(
            dataset_save_path):
        ...
        torch.save(ds.ds, dataset_save_path)
